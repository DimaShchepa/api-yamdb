# Generated by Django 5.1.1 on 2026-07-11 09:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.SmallIntegerField(validators=[django.core.validators.MinValueValidator(1, message='Год должен быть не меньше 1.'), django.core.validators.MaxValueValidator(2026, message='Год не может быть большетекущего (2026).')], verbose_name='Год выпуска')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='reviews.title', verbose_name='Название произведения')),
            ],
            options={
